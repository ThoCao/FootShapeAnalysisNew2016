...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LogViewer_t, stringdata) + ofs \
...
const QMetaObject LogViewer::staticMetaObject = {
    { &QPlainTextEdit::staticMetaObject, qt_meta_stringdata_LogViewer.data,
      qt_meta_data_LogViewer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
